...
pub(crate) mod inlines {
    ...
    pub fn d_i_m_m_i_same_mass<T: Num>(q: R, p: R, m: T, beta: R) -> T {
        ...
        let rpinv = (p + 2. * q).inv();
        let rminv = (p - 2. * q).inv();
        -bose_distribution_zero_chempot(en, beta) * (en * p * 4. * PI2).inv() * (rpinv + rminv)
    }
    ...
    pub fn d_i_0_0_i(q: R, p: R, beta: R) -> R {
        let rpinv = (p + 2. * q).inv();
        let rminv = (p - 2. * q).inv();
        -bose_distribution_zero_chempot(q, beta) * (q * p * 4. * PI2).inv() * (rpinv + rminv)
    }
...
mod tests {
    ...
    fn test_d_i_m_m_i() {
        ...
        let res: [C; 6] = [
            -0.0002702473201163251 + 0. * I,
            -0.000249871523400852 + 0. * I,
            0.000319457017732362 + 0. * I,
            -4.221914354706696e-06 + 0. * I,
            -2.7718172825244943e-08 + 0. * I,
            0.0015950804753166019 + 0. * I,
        ];
    ...
    fn test_d_i_m_m_i_m_0() {
        ...
        let res: [C; 5] = [
            -0.0007162961268931895 + 0. * I,
            -0.0007684205607343753 + 0. * I,
            -0.0028915039556439395 + 0. * I,
            -7.204384932949508e-05 + 0. * I,
            -0.001142827168247767 + 0. * I,
        ];
    ...
    fn test_d_i_m_m_i_0_0() {
        ...
        let res: [C; 4] = [
            -0.004165062903571438 + 0. * I,
            -0.01678780568020066 + 0. * I,
            -0.08420319687476983 + 0. * I,
            -2.5285760218180617 + 0. * I,
        ];
    ...
    fn test_d_i_m_m_i_same_mass() {
        ...
        let res: [R; 5] = [
            -0.0001612557708689092,
            -0.00018108878587021974,
            -0.0009082934946302572,
            -9.103450863458222e-08,
            -0.015357956308516565,
        ];
    ...
    fn test_d_i_m_0_i() {
        ...
        let res: [R; 5] = [
            -0.0007162961268931895,
            -0.0007684205607343753,
            -0.0028915039556439395,
            -7.204384932949508e-05,
            -0.001142827168247767,
        ];
